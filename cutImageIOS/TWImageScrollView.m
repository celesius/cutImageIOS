...
- (void)layoutSubviews
{
    ...
    self.imageView.frame =  frameToCenter;// CGRectMake(CGRectGetMinX(frameToCenter), CGRectGetMinY(frameToCenter) + 30, CGRectGetWidth(frameToCenter), CGRectGetHeight(frameToCenter));//frameToCenter;
}
...
- (void)displayImage:(UIImage *)image
{
    ...
    self.imageView.frame =  CGRectMake(0, 44, CGRectGetWidth(frame), CGRectGetHeight(frame));//  frame;
...
- (void)configureForImageSize:(CGSize)imageSize
{
    ...
    if (imageSize.width > imageSize.height) {
        ...
        //self.contentOffset = CGPointMake(0, imageSize.height/4 - 44);  //jiangbo
